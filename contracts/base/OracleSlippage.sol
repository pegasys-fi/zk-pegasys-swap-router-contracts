...
import '@pegasys/v3-periphery/contracts/base/BlockTimestamp.sol';
...
import '@pegasys/v3-periphery/contracts/libraries/OracleLibrary.sol';
...
abstract contract OracleSlippage is IOracleSlippage, PeripheryImmutableState, BlockTimestamp {
    ...
    function getBlockStartingAndCurrentTick(IPegasysV3Pool pool)
        internal
        view
