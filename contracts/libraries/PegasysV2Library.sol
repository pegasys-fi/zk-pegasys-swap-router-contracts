...
import '@pegasys/v2-core/contracts/interfaces/IPegasysV2Pair.sol';
...
library PegasysV2Library {
    ...
    function getReserves(
        ...
        (uint256 reserve0, uint256 reserve1, ) = IPegasysV2Pair(pairFor(factory, tokenA, tokenB)).getReserves();
